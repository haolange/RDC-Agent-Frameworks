---
name: driver-device
description: Internal specialist skill for performing cross-device attribution and platform-specific checks. Use this when `rdc-debugger` dispatches driver-device work.
---
