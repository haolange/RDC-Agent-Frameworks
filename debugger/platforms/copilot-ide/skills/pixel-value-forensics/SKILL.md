...
description: Internal specialist skill for locating first bad event and pixel-level evidence. Use this when `rdc-debugger` dispatches pixel-value-forensics work.
---
