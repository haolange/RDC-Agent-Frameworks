...
description: Internal specialist skill for producing BugFull and BugCard outputs and maintaining reusable knowledge. Use this when `rdc-debugger` dispatches report-knowledge-curator work.
---
