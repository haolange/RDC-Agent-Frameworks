---
name: capture-repro
description: Internal specialist skill for establishing reproducible capture baselines and anchors. Use this when `rdc-debugger` dispatches capture-repro work.
---
