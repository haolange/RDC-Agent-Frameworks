...
description: Map symptoms and triggers to normalized tags and SOP candidates. Use this agent for triage and taxonomy tasks to analyze bug descriptions and recommend investigation paths.
target: vscode
