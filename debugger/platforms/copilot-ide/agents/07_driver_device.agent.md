---
name: driver-device
description: Perform cross-device attribution and platform-specific checks. Use this agent for driver and device-level debugging across different platforms.
target: vscode
