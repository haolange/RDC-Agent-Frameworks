---
name: shader-ir
description: Analyze shader source, IR evidence, and suspicious fingerprints. Use this agent for shader analysis and intermediate representation debugging.
target: vscode
