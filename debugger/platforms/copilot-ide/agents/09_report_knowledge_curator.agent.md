...
description: Produce BugFull and BugCard outputs and maintain reusable knowledge. Use this agent for generating reports and curating debugging knowledge.
target: vscode
